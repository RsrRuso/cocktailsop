      ...
      <div className="pt-16 px-4 max-w-7xl mx-auto">
        ...
        >
          ...
          <motion.a
            ...
            className="inline-flex items-center gap-2 mt-4 px-4 py-2 bg-gradient-to-r from-primary to-blue-600 text-white rounded-full text-sm font-medium hover:opacity-90 transition-opacity shadow-lg"
          >
