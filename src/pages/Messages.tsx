  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background via-background/98 to-background pb-20">
      ...
      <div className="pt-16 px-3 sm:px-4">
        ...
        <div className="py-3 sm:py-4 space-y-3">
          <div className="flex items-center justify-between gap-2">
            <div className="flex items-center gap-2 sm:gap-3 min-w-0">
              <h1 className="text-2xl sm:text-4xl font-bold bg-gradient-to-r from-primary via-accent to-primary bg-clip-text text-transparent animate-gradient truncate">
                Neuron
              </h1>
              <Button
                size="sm"
            ...
            <Button 
              ...
              className="glass hover:scale-105 transition-all text-xs h-8 px-2 sm:px-3"
            >
          ...
          <div className="flex gap-2 overflow-x-auto pb-1 scrollbar-hide -mx-3 px-3">
            <Button 
              ...
              size="sm"
              className="glass bg-accent/20 hover:bg-accent/30 hover:scale-105 transition-all whitespace-nowrap h-9 text-xs"
            >
            ...
            <Button 
              ...
              size="sm"
              className="glass bg-primary/20 hover:bg-primary/30 hover:scale-105 transition-all whitespace-nowrap h-9 text-xs"
            >
        ...
        {/* Search with modern styling - mobile optimized */}
        ...
        {/* Stats with improved design - mobile optimized */}
        {!showArchived && (
