        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="text-left">
              <h3 className="font-semibold text-white">Update Music Library</h3>
              <p className="text-sm text-muted-foreground">Sync your Spotify tracks</p>
            </div>
          </div>
          <svg className="w-5 h-5 text-muted-foreground group-hover:text-white transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
