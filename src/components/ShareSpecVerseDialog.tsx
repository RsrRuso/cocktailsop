...
const SHAREABLE_TOOLS: ShareableTool[] = [
  ...
  },
  {
    ...
    solution: 'Batch Calculator instantly scales any cocktail recipe to any batch size with perfect precision. Share recipes with your team instantly - one tap shows the full spec. Track production history, log who made what and when, and maintain complete batch documentation for inventory and quality control.',
    benefits: ['One-click scaling from 1 serve to 1000 liters', 'Instant recipe sharing with team access', 'Complete production history & team attribution', 'Perfect precision eliminates costly batch errors'],
        ...
        {view === 'select' ? (
          ...
          <ScrollArea className="h-[65vh] px-3 pb-3">
            ...
            <p className="text-[10px] text-muted-foreground text-center">
              Story includes link to {selectedTool.name}
            </p>
          </ScrollArea>
        )}
      </DialogContent>
