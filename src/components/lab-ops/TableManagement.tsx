          ...
          <Card>
            ...
            <CardContent className="p-0">
              <FloorPlanCanvas 
                ...
                tables={tables}
                setTables={setTables}
                selectedTableForMove={selectedTableForMove}
                setSelectedTableForMove={setSelectedTableForMove}
                draggingTable={draggingTable}
                setDraggingTable={setDraggingTable}
                dragOffset={dragOffset}
                setDragOffset={setDragOffset}
                handleTableDrag={handleTableDrag}
