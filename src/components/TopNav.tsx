    ...
    <>
      <div className={`fixed top-0 left-0 right-0 z-50 transition-transform duration-300 ${isVisible ? 'translate-y-0' : '-translate-y-full'}`}>
        <div className="flex items-center justify-between px-3 sm:px-4 py-2 sm:py-3">
          ...
          {/* Right section - Notifications, Messages, and Menu */}
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="glass z-[60] bg-background/95 backdrop-blur-xl border border-border/50 w-56">
                {/* Navigation Items */}
                <DropdownMenuItem
                  onClick={() => { 
                    lightTap(); 
