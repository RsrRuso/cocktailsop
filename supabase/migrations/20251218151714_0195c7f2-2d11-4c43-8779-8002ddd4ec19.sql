-- Drop and recreate the notify_batch_group_members function with proper search_path
...
BEGIN
  -- Loop through all group members and insert notifications (excluding submitter)
  FOR member_record IN 
    SELECT user_id FROM public.mixologist_group_members 
    WHERE group_id = p_group_id 
    AND (p_submitter_id IS NULL OR user_id != p_submitter_id)
  LOOP
