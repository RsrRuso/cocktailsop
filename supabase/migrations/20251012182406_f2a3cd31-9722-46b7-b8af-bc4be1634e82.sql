...
DROP TRIGGER IF EXISTS on_music_share_like ON public.music_share_likes;
DROP TRIGGER IF EXISTS on_music_share_comment ON public.music_share_comments;
DROP TRIGGER IF EXISTS on_event_like ON public.event_likes;
DROP TRIGGER IF EXISTS on_event_comment ON public.event_comments;
DROP TRIGGER IF EXISTS on_event_attendance ON public.event_attendees;
