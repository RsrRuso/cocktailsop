...
ALTER TABLE profiles ADD COLUMN IF NOT EXISTS user_type text CHECK (user_type IN ('entrepreneur', 'investor', 'both')) DEFAULT 'entrepreneur';
...
-- Create idea_interests table (like a connection/bookmark)
