                      ...
                      : r.pathTemplate === '/reports/cash-flow'
                        ...
                        : r.pathTemplate === '/reports/labor-cost'
                          ...
                          : r.pathTemplate === '/reports/cogs'
                            ...
                            : r.pathTemplate === '/inventory-valuation-report'
                            ...
                            : r.pathTemplate === '/wastage-tracker'
                              ? navigation.navigate('WastageTracker')
                            ...
                            : r.pathTemplate === '/stock-audit'
                              ? navigation.navigate('StockAudit')
                            : r.pathTemplate === '/sales-report'
